...
@dataclass
class SMIMITIDISIFGSM(Serializable):
    """
        Configuration for MIFGSM attack
    """
    n_iters: int
...
@dataclass
class PITIDIFGSSM(Serializable):
    """
        Configuration for MIFGSM attack
    """
    n_iters: int
