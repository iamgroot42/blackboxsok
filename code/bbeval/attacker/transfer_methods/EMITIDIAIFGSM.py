...
class EMITIDIAIFGSM(Attacker):
    ...
    def attack(self, x_orig, x_adv=None, y_label=None, x_target=None, y_target=None):
                ...
                for s in range(size):
                    ...
                    for j in ch.arange(m):
                        ...
                        #     Trying to backward through the graph a second time
                            ...
                            loss.backward()
                        grad_bar += x_nes.grad.data / sampling_number / m / size
        ...
        # print("The transferbility of EMITIDIAIFGSM is %s %%" % str(transferability))
