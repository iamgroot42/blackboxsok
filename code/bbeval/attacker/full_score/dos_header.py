...
from secml_malware.attack.blackbox.c_black_box_format_exploit_evasion import CBlackBoxContentDOSExtensionProblem
...
class DOSExtend(Attacker):
    ...
    def _attack(self,
        ...
        attack = CBlackBoxContentDOSExtensionProblem(
                    self.local_phi_net,
